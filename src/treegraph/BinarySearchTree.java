...
//            depth++;
    ...
    //Count depth, with parameter as the root node, and traverse from there
    private int countDepth(Node<T> node) {
        if (node == null) {
            return 0;
        } else {
    ...
    //Invokes the recusion countDepth
    public void getAvgDepth() {
        System.out.println("The depth of the tree is  " + countDepth(root));
        System.out.println("The size of inputs is " + size);
